...
const Services = () => {
  return (
    <section id="services" className='flex w-full h-full'>
      <div className='grid grid-cols-2 w-full h-full text-[#979797] mt-20'>
        <div className='flex flex-col justify-center items-center p-10  '>
          <div className='flex border-4 rounded-lg border-[#ac7bb6] mb-4'>
            <Image src='/assets/services1.png' alt='Services Me' width={500} height={500} className='rounded-lg shadow-md w-80 h-80' />
          </div> 
